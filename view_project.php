			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
								<dt><b class="border-bottom border-primary">Subject Name</b></dt>
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Department Manager</b></dt>
								<dd>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Activity</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Reply</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
